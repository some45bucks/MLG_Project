...
from modified_sample_factory.model.actor_critic import ActorCritic, ActorCriticGeo, default_make_actor_critic_func, default_make_actor_critic_geo_func
from modified_sample_factory.model.core import ModelCore, default_make_core_func
from modified_sample_factory.model.decoder import Decoder, default_make_decoder_func
from modified_sample_factory.model.encoder import Encoder, default_make_encoder_func
...
MakeActorCriticGeoFunc = Callable[[Config, ObsSpace, ActionSpace], ActorCriticGeo]
...
class ModelFactory:
    def __init__(self):
        ...
        self.make_actor_critic_geo_func: MakeActorCriticGeoFunc = default_make_actor_critic_geo_func
    ...
    def register_actor_critic_geo_factory(self, make_actor_critic_geo_func: MakeActorCriticGeoFunc):
        """
        Override the default actor-critic with a custom model.
        """
        log.debug(f"register_actor_critic_geo_factory: {make_actor_critic_geo_func}")
        self.make_actor_critic_geo_func = make_actor_critic_geo_func
