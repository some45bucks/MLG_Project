...
from modified_sample_factory.launcher.run_ngc import add_ngc_args, run_ngc
from modified_sample_factory.launcher.run_processes import add_os_parallelism_args, run
from modified_sample_factory.launcher.run_slurm import add_slurm_args, run_slurm
...
def launcher_argparser(args) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="Name of the python module that describes the run, e.g. viz_doom_sf.experiments.paper_doom_all_basic_envs.py "
